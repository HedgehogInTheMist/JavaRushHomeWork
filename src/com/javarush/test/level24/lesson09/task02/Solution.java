    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                int  names = s.compareTo(s2);

                if (names != 0){
                    return names;
                } else {
                    Date d = (Date) stock1.get("date");
                    Date d2 = (Date) stock2.get("date");
                    int date = d.compareTo(d2);
                    if (date != 0){
                        return date;
                    } else {
                        Double change = null;
                        ...
                        if (stock1.containsKey("change")){
                            change = (Double) stock1.get("change");
                        } else {
                            change = (Double) stock1.get("open") - (Double) stock1.get("last");
                        }
                        ...
                        int profit = change2.compareTo(change);
                        if (profit != 0){
                            return profit;
                        } else {
                            return 0;
